...
INPUT_MODEL_PATH = "${DATAPOOL_ROOT}/model/base/Qwen3-4B-TP8-PP1"
OUTPUT_MODEL_PATH = "${DATAPOOL_ROOT}/model/cpt_checkpoints/mg_tp8"
INPUT_DATA_PATH = "${DATAPOOL_ROOT}/data/tokenized/cpt/output"
